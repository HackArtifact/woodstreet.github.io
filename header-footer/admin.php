...
<div class="header-navbar">
    ...
    <div class="admin-store-location-navbar">
        <a class="inter-normal-thunder-16px" href="Location.php">
            Store Location
        </a>
    </div>
    <div class="admin-contact-us-navbar">
        <a class="inter-normal-thunder-16px" href="ContactUs.php">
            Contact US
        </a>
    </div>
    ...
    <div class="admin-repair-services-navbar">
        <a class="inter-normal-thunder-16px" href="Bookings.php">
            Repair services
        </a>
    </div>
